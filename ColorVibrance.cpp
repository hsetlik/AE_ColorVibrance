	...
	PF_LayerDef		*output )
{
	...
	PF_ADD_FLOAT_SLIDERX(	STR(StrID_Gain_Param_Name), 
							COLORVIBRANCE_GAIN_MIN, 
							COLORVIBRANCE_GAIN_MAX, 
							COLORVIBRANCE_GAIN_MIN, 
							COLORVIBRANCE_GAIN_MAX, 
							COLORVIBRANCE_GAIN_DFLT,
	...
	out_data->num_params = COLORVIBRANCE_NUM_PARAMS;
	...
	PF_LayerDef		*output )
{
	...
	giP.gainF 	= params[COLORVIBRANCE_GAIN]->u.fs_d.value;
	
	if (PF_WORLD_IS_DEEP(output)){
		ERR(suites.Iterate16Suite1()->iterate(	in_data,
												0,								// progress base
												linesL,							// progress final
												&params[COLORVIBRANCE_INPUT]->u.ld,	// src 
